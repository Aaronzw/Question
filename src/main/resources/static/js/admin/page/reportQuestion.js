...
layui.define(['element', 'form','laypage','jquery','laytpl','common','table'],function(exports){
    ...
    function initList(){
        table.render({
            ...
            // ,height: 315 //容器高度
            ,url: '/getReportedQuestionList' //数据接口
            ,where:{"status":0}
            ,request: {
            ...
            ,cols:  [[ //表头
                ...
                {field: 'title', title: '标题', width:300, fixed: 'left',templet: function(d){
                        return '<a href="/question/'+d.question.id+'">'+d.question.title+'</a>'
                    }
                 },
                {field: 'content', title: '内容', width:100, fixed: 'left',templet: function(d){
                        return '<a href="/question/'+d.question.id+'">'+d.question.content+'</a>'
                    }
                },
        ...
        table.render({
            ...
            ,cols:  [[ //表头
                ...
                {field: 'reportTime', title: '举报时间', width:130, fixed: 'left',templet: function(d){
                        return '<a>'+d.report.createdDate+'</a>';
                    }
                },
                {field: 'reportTime', title: '处理时间', width:130, fixed: 'left',templet: function(d){
                        return '<a>'+d.report.dealDate+'</a>';
                    }
                },
                {field: 'dealer', title: '处理人id', width:100, fixed: 'left',templet: function(d){
    ...
    function initEvent(){
        $(document).on('click','.js-del-ques',function(){
            var here=$(this);
            var report_id=here.attr("data-report");
            console.log(report_id);
            layer.confirm("删除该问题？",function (index) {
